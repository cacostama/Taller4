...
if ($resultado[0]['usu_cod'] == null) {
    ...
    header('location:index.php'); //En caso de error el vuelve al index
} else {
    ...
    $_SESSION['id_sucursal'] = $resultado[0]['suc_cod'];
    $_SESSION['sucursal'] = $resultado[0]['suc_descripcion'];
    header('location:menu.php'); //Aqui LLama al Menu 
}

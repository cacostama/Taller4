...
<body class="hold-transition skin-purple sidebar-mini">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        $depositos = consultas::get_datos("select * from deposito where dep_descri ilike '%" . (isset($_REQUEST['buscar']) ? $_REQUEST['buscar'] : "") . "%'order by dep_id");
                                        if (!empty($depositos)) { ?>
                                                        ...
                                                        <?php foreach ($depositos as $deposito) { ?>
                                                            <tr>
                                                                ...
                                                                <td data-title="Acciones" class="text-center">
                                                                    <a onclick="editar(<?php echo "'" . $deposito['dep_id'] . "_" . $deposito['dep_descri'] . "'"; ?>)" class="btn btn-warning btn-sm" role="buttom" data-title="Editar" rel="tooltip" data-toggle="modal" data-target="#editar">
                                                                        <i class="fa fa-edit"></i>
                                                                    </a>
                                                                    <a onclick="borrar(<?php echo "'" . $deposito['dep_id'] . "_" . $deposito['dep_descri'] . "'"; ?>)" class="btn btn-danger btn-sm" role="buttom" data-title="Borrar" rel="tooltip" data-toggle="modal" data-target="#borrar">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="deposito_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                        ...
                        <input type="hidden" name="vdep_id" value="0">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="deposito_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                        ...
                        <input type="hidden" name="vdep_id" id="cod" value="0">
                        <div class="modal-body">
                            <div class="form-group">
                                <label class="control-label col-sm-2">Nombre:</label>
                                <div class="col-sm-10">
    ...
    <script>
        ...
        function borrar(datos) {
            var dat = datos.split("_");
            $('#si').attr('href', 'deposito_control.php?vdep_id=' + dat[0] + '&vdep_descri=' + dat[1] + '&accion=3');
